...
class CursosViewSet(viewsets.ModelViewSet):
    ...
    queryset = Curso.objects.all().order_by('codigo_curso')
...
class ListaMatriculasAluno(generics.ListCreateAPIView):
    """Listando as matriculas de um estudante"""
...
class ListaAlunosMatriculados(generics.ListCreateAPIView):
    """Listando estudantes matriculados em um curso
    """
